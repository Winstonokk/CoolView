...
import com.barnettwong.view_library.util.DisplayUtil;

/**
 * Created by wang on 2018/9/11.
 **/
public class ExpandableTextView extends LinearLayout implements View.OnClickListener {
    ...
    private void init(AttributeSet attrs) {
        ...
        collapseExpandTextColor = typedArray.getColor(R.styleable.ExpandableTextView_collapseExpandTextColor, ContextCompat.getColor(getContext(), R.color.main_style_color));
